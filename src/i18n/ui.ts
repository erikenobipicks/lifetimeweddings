...
export const ui = {
  es: {
    ...
    'quote.session.hero.body': 'Gracias por vuestro interés. Aquí tenéis la propuesta para vuestra sesión de pareja: elegid lo que más os encaje y decidnos cuándo os va bien.',
    'quote.session.gallery.eyebrow': 'Un vistazo',
    'quote.session.gallery.heading': 'Así son nuestras sesiones de pareja',
    'quote.session.instagram': 'Más fotos en nuestro Instagram',
    'quote.session.deposit.cta': 'Reservar con depósito (50%)',
    'quote.session.deposit.hint': 'Pagáis el 50% ahora y reserváis la fecha; el resto, el día de la sesión. También podéis enviarnos vuestra elección sin pagar.',
    'quote.session.deposit.sending': 'Redirigiendo al pago…',
    'quote.session.deposit.error': 'No hemos podido iniciar el pago. Probad de nuevo o escribidnos.',
    'quote.session.deposit.paid': '¡Depósito recibido! Hemos reservado vuestra sesión. Os escribimos enseguida.',
    'quote.session.note': '* Precio para sesiones entre semana / no festivos, al atardecer, en una localización a 15–20 min de Reus / Tarragona. Desplazamientos más lejanos, a consultar.',
    ...
    'quote.configurator.extrasOwn': 'Foto y vídeo',
    'quote.configurator.extrasExternal': 'Servicios externos',
  ...
  ca: {
    ...
    'quote.session.hero.body': 'Gràcies pel vostre interès. Aquí teniu la proposta per a la vostra sessió de parella: trieu el que més us encaixi i digueu-nos quan us va bé.',
    'quote.session.gallery.eyebrow': 'Un tast',
    'quote.session.gallery.heading': 'Així són les nostres sessions de parella',
    'quote.session.instagram': 'Més fotos al nostre Instagram',
    'quote.session.deposit.cta': 'Reservar amb dipòsit (50%)',
    'quote.session.deposit.hint': 'Pagueu el 50% ara i reserveu la data; la resta, el dia de la sessió. També ens podeu enviar la vostra tria sense pagar.',
    'quote.session.deposit.sending': 'Redirigint al pagament…',
    'quote.session.deposit.error': 'No hem pogut iniciar el pagament. Torneu-ho a provar o escriviu-nos.',
    'quote.session.deposit.paid': 'Dipòsit rebut! Hem reservat la vostra sessió. Us escrivim de seguida.',
    'quote.session.note': '* Preu per a sessions entre setmana / no festius, a la posta de sol, en una localització a 15–20 min de Reus / Tarragona. Desplaçaments més llargs, a consultar.',
    ...
    'quote.configurator.extrasOwn': 'Foto i vídeo',
    'quote.configurator.extrasExternal': 'Serveis externs',
    'quote.configurator.typePhoto': 'Foto',
    'quote.configurator.typeVideo': 'Vídeo',
    'quote.configurator.typeCombo': 'Combo',
    'quote.configurator.subtotal': 'Subtotal',
  ...
  en: {
    ...
    'quote.session.hero.body': 'Thanks for your interest. Here is the proposal for your couple session: pick what suits you best and let us know when works for you.',
    'quote.session.gallery.eyebrow': 'A glimpse',
    'quote.session.gallery.heading': 'This is what our couple sessions look like',
    'quote.session.instagram': 'More on our Instagram',
    'quote.session.deposit.cta': 'Reserve with a 50% deposit',
    'quote.session.deposit.hint': 'Pay 50% now to hold the date; the rest on the day of the session. You can also just send us your choice without paying.',
    'quote.session.deposit.sending': 'Redirecting to payment…',
    'quote.session.deposit.error': 'We could not start the payment. Please try again or message us.',
    'quote.session.deposit.paid': 'Deposit received! Your session is booked. We will write to you shortly.',
    'quote.session.note': '* Price for weekday / non-holiday sessions at golden hour, at a location within 15–20 min of Reus / Tarragona. Longer trips quoted on request.',
    ...
    'quote.configurator.extrasOwn': 'Photo & video',
    'quote.configurator.extrasExternal': 'External services',
